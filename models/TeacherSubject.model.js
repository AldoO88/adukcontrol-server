...
//   { teacher_id: <carlos>, subject: "Matemáticas", group_id: <2B-2024>, school_year_id: <2024-2025> }
//
...
const teacherSubjectSchema = new Schema(
  {
    ...
    // El nombre de la materia (string, matching con Grade.subject)
    subject: {
      type: String,
...
teacherSubjectSchema.index(
  { teacher_id: 1, subject: 1, group_id: 1, school_year_id: 1 },
  { unique: true, name: "uniq_teacher_subject_group_year" }
);
...
teacherSubjectSchema.index({ group_id: 1, subject: 1, school_year_id: 1 });
