...
router.get("/", authorize("admin", "principal", "registrar", "teacher", "prefect", "social_worker"), getAllSubjects);
router.post("/", authorize("admin", "registrar"), createSubject);
router.get("/:subjectId", authorize("admin", "principal", "registrar", "teacher", "prefect", "social_worker"), getSubjectById);
